...
/**
 * @brief Return values of values vector channels
 * @param channel: channel number to return the specific value
 * @param targetSS SPI target to talk to: BOARD_ADS, SLAVE_ADS or BOTH_ADS
 * @return value in the channel indicated by channel_number parameter
 */
uint32_t Drv_ADS1299_getboardData(uint8_t channel_number, uint8_t targetSS);

/**
 * @brief Return gain of specific channel
 * @param channel: channel number to return the specific value
 * @param targetSS SPI target to talk to: BOARD_ADS, SLAVE_ADS or BOTH_ADS
 * @return return gain value to specific channel
 */
