...
#define BOARD_ADS_PIN	2//16 //Master ADS chip select pin
#define BOARD_ADS_PORT  2//0  //Master ADS chip select port

#define SLAVE_ADS_PIN	2//28 // Slave ADS chip select pin
#define SLAVE_ADS_PORT  2//1  //Slave ADS chip select port
...
//FRDM configuration
#define START 38 	// ADS start pin
#define RESET 36 	// ADS reset pin
#define PWDN 35  	// ADS power down pin
#define DRDY 47  	// ADS data ready pin
#define LED_ON 26   // Board "ON" pin
#define CS_SPI 39   // ADS chip select pin
