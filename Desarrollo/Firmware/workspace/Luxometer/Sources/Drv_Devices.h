...
#define MS_PIN			13//27 // M/S (Master/Slave) signal pin
#define MS_PORT			2//1  // M/S signal port

#define LED_R_PIN		0//0 // Red LED pin
#define LED_R_PORT		2//1 // Red LED port

#define LED_V_PIN		1//1 // Green LED pin
#define LED_V_PORT		2//1 // Green LED port
